...
def sparse_continents
  # Find every country in a continent
  
  # Find the continents where each country's population is less than 25,000,000.
    ...
    WHERE
      continent in (
        ...
        FROM 
          ...
          FROM countries
          GROUP BY continent) as max_population
  ...
  #   LIMIT 1) as max_population
  # GROUP BY continent
  # WHERE max_population.population < 25000000)

# subquery: selects the highest population
# subquery goal: select the highest population in each continent
  # continent | highest population
  ################################